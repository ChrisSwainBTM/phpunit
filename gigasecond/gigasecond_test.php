...
class GigasecondTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testNoMutation()
    {
        ...
        $this->assertNotEquals($date, $gs->format("Y-m-d H:i:s"));
    }
    ...
    public function testYourself()
    {
        ...
        $your_birthday = GigasecondTest::dateSetup("1982-11-06");
        $gs = from($your_birthday);

        $this->assertSame("2014-07-15 01:46:40", $gs->format("Y-m-d H:i:s"));
    }
}
